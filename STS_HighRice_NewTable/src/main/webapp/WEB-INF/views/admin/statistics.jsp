...
<body>
	<div data-role="content">
      ...
      <div id="tab_statMember" class="stat_list">
         ...
         <ul id="order_ul" data-role="listview" data-icon="false" data-divider-theme="d" style="margin: 15px 0;">
      ...
      <div id="tab_statSearch" class="stat_list">
         ...
         <ul id="dayVisit_ul" data-role="listview" data-icon="false" data-divider-theme="d" style="margin: 15px 0;">
         	<li data-role="list-divider">요일별 방문자수</li>
         	<div id="graph_dayVisit">요일별 방문자수 그래프</div>
         </ul>
         <ul id="timemVisit_ul" data-role="listview" data-icon="false" data-divider-theme="d" style="margin: 15px 0;">
