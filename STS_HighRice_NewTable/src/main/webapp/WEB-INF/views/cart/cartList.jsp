         ...
         <div class="ui-grid-a">
            ...
            <div class="ui-block-b" style="width: 64%; padding-top: 5%;<c:if test="${list.pay_date == '1111-11-11' }">opacity: .20; </c:if>">
               ...
               <div>
                  ...
                  <table style="padding-left: 5%; margin-top: -0.6em; ">
                                   <tr style="text-align: center;"><td>
                                     <input type="text" data-role="none" name="rent_month" id="rent_month${cnt.count }" value="${list.rent_month }" readonly="readonly" size="2" maxlength=2;">
                                   <td valign=middle height=25>
                                    <input type=button class="increaseRentMonthBtn" data-role="none" value="▲" style="background-color:white; border:0; height:10px; font-size:12px; margin:0; padding:0;" cnt="${cnt.count }"><br>
                                     <input type=button class="reduceRentMonthBtn" data-role="none" value="▼" style="background-color:white; border:0; height:10px; font-size:12px; margin:0; padding:0;" cnt="${cnt.count }">
                                    </td>
                                </td></tr>
                  </table>
               </div>
...
<!--          ---------------------------------------------------------------------------------------------------- -->
   <div style="width: 93%; margin: 3%; padding:1%; background-color: #ddd;">
      <center><p style="color: #0054FF; font-size:3.5vw; font-weight: bold;">주문 결제 정보</p></center>
   </div>
   <div class="ui-grid-a">
   ...
   <div class="ui-grid-a">
      <div class="ui-block-a" style="padding-left: 5%;">총 주문 금액</div>
   ...
   <div class="ui-grid-a" style="margin-bottom: 10%; margin-top: 5%;">
      <div class="ui-block-a">
         <a data-role="button" style="text-align: center;" data-corners="false" data-theme="a" id="buySelectProduct">선택상품주문</a>
      </div>
      <div class="ui-block-b">
         <a data-role="button" style="text-align: center;" data-corners="false" data-theme="a" id="buyAllProduct">전체상품주문</a>
      </div>
   </div>
