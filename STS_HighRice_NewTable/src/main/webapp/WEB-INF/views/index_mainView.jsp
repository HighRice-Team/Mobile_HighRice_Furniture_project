	...
	<div data-role="content">
		...
		<center>
			<c:if test="${category == null}">
				<p><div><h3>전체 가구 목록</h3></div></p>
			</c:if>
			<c:if test="${category != null}">
				<p><div><h3>${category} 목록</h3></div></p>
			</c:if>
		...
		<div data-role="navbar" data-position="inline">
			<ul>
				<li><a href="index.do?category=SOFA" data-ajax="false">SOFA</a></li>
				<li><a href="index.do?category=BED" data-ajax="false">BED</a></li>
				<li><a href="index.do?category=CLOSET" data-ajax="false">CLOSET</a></li>
				<li><a href="index.do?category=DESK" data-ajax="false">DESK</a></li>
			</ul>
		</div>
		<br>
		...
		<div data-role="collapsible" data-theme="d" data-collapsed-icon="search" data-expanded-icon="search" data-iconpos="right">
			<h3>Filter</h3>
			<form action="index.do" id="filter_form" method="post" data-ajax="false">
		...
		<div style="width: 100%; display: inline-block;" id="product_box" >
         ...
         <div id="page">
            <c:forEach var="pageNum" begin="1" end="${pageMax }">
               <a href="index.do?pageNum=${pageNum }&category=${category}&quality=${quality}&max=${max }&min=${min }" data-ajax="false">${pageNum}&nbsp;&nbsp;&nbsp;</a>
            </c:forEach>
         </div>
         </center>
